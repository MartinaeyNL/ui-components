  ...
  render: (args) => html`
    <div style="display: flex; gap: 12px;">
      ${helpers.template(args[0], html`
        <ui-icon icon="stopwatch" slot="prefix"></ui-icon>`)}
      ${helpers.template(args[1], html`
        <ui-icon icon="check-lg" slot="suffix"></ui-icon>`)}
    </div>
  `,
  args: [
...
export const IconOnlyExample = {
  ...
  render: (args) => html`
    <div style="display: flex; gap: 12px;">
      ${helpers.template(args[0], html`
        <ui-icon icon="check-lg"></ui-icon>`)}
      ${helpers.template(args[1], html`
        <ui-icon icon="bug"></ui-icon>`)}
    </div>
  `,
  args: [
...
export const examples = [VariantExample, IconWithTextExample, IconOnlyExample, SmallExample, FilledExample, PillExample];
